...
export class RegistrationsService {
  ...
  async create(activityId: string, riderId: string, dto: CreateRegistrationDto) {
    ...
    const checkpoints = activity.checkpoints.filter(
      (cp) => cp.type === CheckpointType.START,
    );
  ...
  async findMyRegistrations(riderId: string, page: number = 1, pageSize: number = 10) {
